...
export class TeamSectionComponent implements OnInit {
  ...
  drewDescription = 'Andrew joined the team in April 2020 in the midst of a global pandemic to help create ' +
    ...
    'apps and web platforms.  Through independent studies at Virginia Tech, he wrote 2 native apps for ' +
    'Android and iOS using Kotlin and Swift and an angular web application.  He also has experience with ' +
    'Angular from his internship with' +
    ' Booz Allen\'s District Defend team in their Strategic Innovation Group.  In addition to his technical ' +
    'background, Andrew also demonstrated effective leadership as the first LGBTQ president of his ' +
    'fraternity, Zeta Psi';
  team = [
